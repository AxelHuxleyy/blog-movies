  ...
  <article>
    ...
    <div class="container-form">
        <div class="header">
            ...
            <div class="menu">
                <a href="rennovacion.php"><li class="module-login active">Actores y peliculas</li></a>
            </div>
        </div>
        
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="form" autocomplete="off">
            <div class="welcome-form"><h1>Relaciona lo actores con las peliculas</h1>
                
        </div>
        <h3 class="welcome-form">Actor: </h3>
            ...
            <h3 class="welcome-form">Pelicula</h3>
            ...
            <button type="submit">Relacionar<label class="lnr lnr-chevron-right"></label></button>
        </form>
    </div>
    </article>
</section>
